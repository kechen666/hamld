                        ...
                        for noise_model in noise_models:
                            for measurement_param in measurement_params:
                                ...
                                if have_stabilizer:
                                    ...
                                    output_file_path = os.path.join(current_file_directory, folder,  f"nkd_{nkd[0]}_{nkd[1]}_{nkd[2]}_r{r}", f"detector_error_model_{noise_model}_p{p}_m{measurement_param}.dem")
                                else:
                                    ...
                                    output_file_path = os.path.join(current_file_directory, folder,  f"nkd_{nkd[0]}_{nkd[1]}_{nkd[2]}_r{r}", f"detector_error_model_{noise_model}_p{p}_m{measurement_param}_no_stabilizer.dem")

                        ...
                        for noise_model in noise_models:
                            for measurement_param in measurement_params:
                                ...
                                if have_stabilizer:
                                    ...
                                    output_file_path = os.path.join(current_file_directory, folder, f"d{d}_r{r}", f"circuit_sample_{noise_model}_p{p}_m{measurement_param}.dat")
                                else:
                                    ...
                                    output_file_path = os.path.join(current_file_directory, folder, f"d{d}_r{r}", f"circuit_sample_{noise_model}_p{p}_m{measurement_param}_no_stabilizer.dat")

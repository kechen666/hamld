...
def replace_values_to_generator_circuit(input_file_path, output_file_path, p, r, have_stabilizer, d, measurement_param):
                    ...
                    for r in rounds:
                        for noise_model in noise_models:
                            for measurement_param in measurement_params:
                                ...
                                if have_stabilizer:
                                    output_file_path = os.path.join(current_file_directory, folder, f"d{d}_r{r}", f"circuit_noisy_{noise_model}_p{p}_m{measurement_param}.stim")
                                else:
                                    output_file_path = os.path.join(current_file_directory, folder, f"d{d}_r{r}", f"circuit_noisy_{noise_model}_p{p}_m{measurement_param}_no_stabilizer.stim")
                                ...
                                replace_values_to_generator_circuit(input_file_path, output_file_path, p_value, r, have_stabilizer, d, measurement_param)

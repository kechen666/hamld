...
class ContractionExecutorInt:
    ...
    def get_task_initial_input(self) -> Tuple[Dict[int, Union[np.float32, np.float64, np.float128]], Dict[str, Union[np.float32, np.float64, np.float128]]]:
        """
        ...
        Returns:
            Tuple[Dict[int, Union[np.float32, np.float64, np.float128]], Dict[str, Union[np.float32, np.float64, np.float128]]]:
                - Initial probability distribution.
                - Dictionary of contractable hyperedge weights.
        """
        init_prob_dist: Dict[int, Union[np.float32, np.float64, np.float128]] = {}
    ...
    def get_parallel_task_initial_input(self) -> Tuple[Dict[int, Union[np.float32, np.float64, np.float128]],
    ...
    def contract_hyperedge(
        self,
        prob_dist: Dict[int, Union[np.float32, np.float64, np.float128]],
        contractable_hyperedges_weights_dict: Dict[str, Union[np.float32, np.float64, np.float128]],
        ...
        Args:
            prob_dist (Dict[int, Union[np.float32, np.float64, np.float128]]): Current probability distribution.
    ...
    def mld_contraction_no_slicing(self, syndrome: np.ndarray[bool]) -> Dict[
        int, Union[np.float32, np.float64, np.float128]]:
        """
        ...
        Returns:
            Dict[int, Union[np.float32, np.float64, np.float128]]: The resulting probability distribution after the contraction.
        """
    ...
    def mld_contraction_serial(self, syndrome: np.ndarray[bool]) -> Dict[int, Union[np.float32, np.float64, np.float128]]:
        """
        ...
        Returns:
            Dict[int, Union[np.float32, np.float64, np.float128]]: A dictionary representing the probability distribution after contraction.
    ...
    def mld_contraction_parallel_concurrent(
        ...
        max_thread: int = 4
    ) -> Dict[int, Union[np.float32, np.float64, np.float128]]:
        """
        ...
        Returns:
            Dict[int, Union[np.float32, np.float64, np.float128]]: The merged probability distribution after contraction.
    ...
    def single_node_online_mld_contraction(
            self,
            syndrome: np.ndarray[bool],
            init_prob_dist: Dict[Tuple[bool, ...], Union[np.float32, np.float64, np.float128]],
        ...
        Args:
            ...
            init_prob_dist (Dict[Tuple[bool, ...], Union[np.float32, np.float64, np.float128]]): Initial probability distribution.
        ...
        Returns:
            Dict[int, Union[np.float32, np.float64, np.float128]]: The updated probability distribution for the given syndrome.
    ...
    @classmethod
    def validate_logical_operator(cls, prob_dist: Dict[int, Union[np.float32, np.float64, np.float128]], logical_operators: str = 'X') -> Tuple[np.ndarray[bool], Union[np.float32, np.float64, np.float128]]:
        """
        ...
        Args:
            prob_dist (Dict[int, Union[np.float32, np.float64, np.float128]]): The resulting probability distribution after contraction.

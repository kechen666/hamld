...
class PyContractionExecutorCpp:
    ...
    def mld_contraction_serial(self, syndrome: np.ndarray[bool]) -> Dict[str, Union[np.float32, np.float64]]:
        """
        ...
        Returns:
            Dict[str, Union[np.float32, np.float64]]: A dictionary representing the probability distribution after contraction.
    ...
    def mld_contraction_parallel_concurrent(
        ...
        Returns:
            Dict[str, Union[np.float32, np.float64]]: The merged probability distribution after contraction.

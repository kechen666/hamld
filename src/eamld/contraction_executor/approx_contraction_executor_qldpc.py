...
logger = setup_logger("contraction_executor/approx_contraction_executor_qldpc", log_level=logging.WARNING)
...
class ApproximateContractionExecutorQldpc:
    def __init__(self, detector_number: int, logical_number: int, order: List[str],
                 ...
                 hyperedge_cache: Optional[Dict] = None, relevant_hyperedge_cache: Optional[Dict] = None):
        """

...
# 基于hierarchical_approx_contraction_executor_qldpc.py函数进行修改
class PriorityApproximateContractionExecutorQldpc:
    ...
    def _priority_sub_hypergraph_contraction_strategy(self):
        ...
        sub_priorty_hypergraph = self.hypergraph.get_priority_sub_hypergraph(nodes = self.flipped_detector_set, priority = self.priority, topk = self.priority_topk)

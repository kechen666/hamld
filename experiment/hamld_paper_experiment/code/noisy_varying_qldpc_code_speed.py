...
logger = setup_logger("epmld_paper_experiment/noisy_varying_qldpc_code_speed", log_level=logging.INFO)
                        ...
                        for r in rounds:
                            for noise_model in noise_models:
                                for decoder_method in decoder_methods:
                                    ...
                                    logger.info(f"Per syndrome decoding time for {code_task}, nkd={nkd}, p={p}, noise_model={noise_model}, decoder={decoder_method}: {average_per_round_time}")
...
# 后台运行命令
# nohup python /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/code/noisy_varying_qldpc_code_speed.py > /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/log/noisy_varying_qldpc_code_speed_output.log 2>&1 &
# 544561
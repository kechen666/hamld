...
logger = setup_logger("epmld_paper_experiment/biased_measurement_qldpc_code_acc", log_level=logging.INFO)

def main():
    # 设置输入数据的相关路径
    related_path = "/home/normaluser/ck/epmld/data/external/epmld_experiment_data/epmld_paper_experiment/bias-measurement/qldpc_code"
    ...
    # 设置待测试的解码方法：
    decoder_methods = ["BP+OSD", "HAMLD", "HAMLD-bias"]  # 只有这三种方法，能够在QLDPC 中运行。
...
# 后台运行命令
# nohup python /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/code/biased_measurement_qldpc_code_acc.py > /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/log/biased_measurement_qldpc_code_acc_output.log 2>&1 &
# 3097086
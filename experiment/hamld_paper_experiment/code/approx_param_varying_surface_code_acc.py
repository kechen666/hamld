...
logger = setup_logger("epmld_paper_experiment/approx_param_varying_surface_code_acc", log_level=logging.INFO)
...
def main():
    ...
    approximate_params = [10, 200, 500]
    # 超图截取的优先级，超图截取的最大数量
    # prioritys = [0, -1, -2]
    # priority_topks = [100, 150, 200]

    prioritys = [0, -1, -2]
    priority_topks = [10, 100, 200]
...
# 后台运行命令
# nohup python /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/code/approx_param_varying_surface_code_acc.py > /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/log/approx_param_varying_surface_code_acc_output.log 2>&1 &
# 3281113
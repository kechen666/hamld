...
logger = setup_logger("epmld_paper_experiment/approx_param_varying_surface_code_speed", log_level=logging.INFO)
...
def main():
    ...
    output_file = os.path.join(output_dir, f"approx_param_varying_surface_code_speed_results_{timestamp}.csv")
...
# 后台运行命令
# nohup python /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/code/approx_param_varying_surface_code_speed.py > /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/log/approx_param_varying_surface_code_speed_output.log 2>&1 &
# 3312387
...
logger = setup_logger("epmld_paper_experiment/approx_param_varying_qldpc_code_speed_cpp", log_level=logging.INFO)
...
def main():
    ...
    output_file = os.path.join(output_dir, f"approx_param_varying_qldpc_code_speed_cpp_results_{timestamp}.csv")
    ...
    # approximate_params = [500, 800, 1000]
    # prioritys = [1, 0, 0, -1]
    # priority_topks = [500, 500, 1000, 1000]
...
# 后台运行命令
# nohup python /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/code/approx_param_varying_qldpc_code_speed_cpp.py > /home/normaluser/ck/epmld/experiment/epmld_paper_experiment/log/approx_param_varying_qldpc_code_speed_cpp_output.log 2>&1 &
# 2577
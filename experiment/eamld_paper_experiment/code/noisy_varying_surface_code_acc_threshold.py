...
logger = setup_logger("eamld_paper_experiment/noisy_varying_surface_code_acc_threshold", log_level=logging.INFO)
...
def main():
    ...
    output_file = os.path.join(output_dir, f"noisy_varying_surface_code_acc_threshold_results_{timestamp}.csv")
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/noisy_varying_surface_code_acc_threshold.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/noisy_varying_surface_code_acc_threshold_output.log 2>&1 &
# 3066818
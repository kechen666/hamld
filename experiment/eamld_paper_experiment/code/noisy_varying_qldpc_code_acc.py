...
logger = setup_logger("eamld_paper_experiment/noisy_varying_qldpc_code_acc", log_level=logging.INFO)
...
def main():
    ...
    output_file = os.path.join(output_dir, f"noisy_varying_qldpc_code_acc_results_{timestamp}.csv")
    ...
    decoder_methods = ["EAMLD"]  # 只测试近似的MLD方法（EAMLD）。
    # 近似的MLD方法的初始化参数：
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/noisy_varying_qldpc_code_acc.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/noisy_varying_qldpc_code_acc_output.log 2>&1 &
# 3174972
...
logger = setup_logger("eamld_paper_experiment/approx_param_varying_qldpc_code_speed", log_level=logging.INFO)

def main():
    # 设置输入数据的相关路径
    related_path = "/home/normaluser/ck/eamld/data/external/eamld_experiment_data/eamld_paper_experiment/approx_param_varying/qldpc_code"
    ...
    # 设置待测试的解码方法：
    decoder_methods = ["EAMLD"] # "eamld"就是
    # 近似的MLD方法的初始化参数：
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/approx_param_varying_qldpc_code_speed.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/approx_param_varying_qldpc_code_speed_output.log 2>&1 &
# 3297694
...
logger = setup_logger("eamld_paper_experiment/biased_measurement_surface_code_acc", log_level=logging.INFO)

def main():
    # 设置输入数据的相关路径
    related_path = "/home/normaluser/ck/eamld/data/external/eamld_experiment_data/eamld_paper_experiment/bias-measurement/surface_code"
    ...
    # 设置待测试的解码方法：
    decoder_methods = ["MWPM", "EAMLD", "EAMLD-bias"]
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/biased_measurement_surface_code_acc.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/biased_measurement_surface_code_acc_output.log 2>&1 &
# 3092913
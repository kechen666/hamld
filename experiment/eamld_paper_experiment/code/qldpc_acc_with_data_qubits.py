...
logger = setup_logger("eamld_paper_experiment/qldpc_acc_with_data_qubits", log_level=logging.INFO)

def main():
    # 设置输入数据的相关路径
    related_path = "/home/normaluser/ck/eamld/data/external/eamld_experiment_data/eamld_paper_experiment/noise_varying_threshold/qldpc_code"
    ...
    decoder_methods = ["BP+OSD", "EAMLD"]  # 只测试近似的MLD方法（EAMLD）。
    # 近似的MLD方法的初始化参数：
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/qldpc_acc_with_data_qubits.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/qldpc_acc_with_data_qubits_output.log 2>&1 &
# 3322681
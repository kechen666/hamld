...
logger = setup_logger("eamld_paper_experiment/approx_param_varying_qldpc_code_acc", log_level=logging.INFO)
...
def main():
    ...
    # 设置待测试的解码方法：
    decoder_methods = ["EAMLD"]  # 近似的MLD方法（EAMLD）的对比。
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/approx_param_varying_qldpc_code_acc.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/approx_param_varying_qldpc_code_acc_output.log 2>&1 &
# 3102142
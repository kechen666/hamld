...
logger = setup_logger("eamld_paper_experiment/overall_performance_surface_code_acc", log_level=logging.INFO)
...
def main():
    ...
    # 创建存储结果的CSV文件并写入表头
    fieldnames = ['code_task', 'detector_number', 'd', 'round', 'approximate_param', 'priority', 'priority_topk', 'decoder_method', 'logical_error_rate', 'have_stabilizer']
    # 如果文件不存在，写入表头
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/overall_performance_surface_code_acc.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/overall_performance_surface_code_acc_output.log 2>&1 &
# 3052359
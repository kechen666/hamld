...
logger = setup_logger("eamld_paper_experiment/overall_performance_qldpc_code_speed", log_level=logging.INFO)
...
def main():
    ...
    output_file = os.path.join(output_dir, f"overall_performance_qldpc_code_speed_results_{timestamp}.csv")
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/overall_performance_qldpc_code_speed.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/overall_performance_qldpc_code_speed_output.log 2>&1 &
# 2077089

# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/overall_performance_qldpc_code_speed.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/overall_performance_qldpc_code_speed_only_bposd_output.log 2>&1 &
# 1905571
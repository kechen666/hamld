...
logger = setup_logger("eamld_paper_experiment/noisy_varying_surface_code_acc_threshold_with_data_qubits", log_level=logging.INFO)

def main():
    # 设置输入数据的相关路径
    related_path = "/home/normaluser/ck/eamld/data/external/eamld_experiment_data/eamld_paper_experiment/noise_varying_threshold/surface_code"

    # 设置输出目录
    output_dir="/home/normaluser/ck/eamld/experiment/eamld_paper_experiment/result"
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    output_file = os.path.join(output_dir, f"noisy_varying_surface_code_acc_threshold_with_data_qubits_results_{timestamp}.csv")
    # output_file = os.path.join(output_dir, f"noisy_varying_surface_code_acc_threshold_with_data_qubits_results.csv")

    # 设置Surface code的相关初始化参数
    code_tasks = ["surface_code:rotated_memory_x","surface_code:rotated_memory_z"]
    # distances = [3, 5, 7, 9]
    distances = [3, 5, 7]
    # probabilities = [0.0005, 0.001, 0.005, 0.01, 0.1, 1]
    # probabilities = [0.0001, 0.001, 0.01, 0.1, 1]
...
# 后台运行命令
# nohup python /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/code/noisy_varying_surface_code_acc_threshold_with_data_qubits.py > /home/normaluser/ck/eamld/experiment/eamld_paper_experiment/log/noisy_varying_surface_code_acc_threshold_with_data_qubits_output.log 2>&1 &
# 3472599